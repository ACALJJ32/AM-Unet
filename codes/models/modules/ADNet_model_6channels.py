...
class ADNet(nn.Module):
    ...
    def forward(self, x1, x2, x3):
        ...
        f2_ = f2_l[0]
        # PCD alignment
        # print(f1_l[0].shape) # torch.Size([8, 64, 256, 256])
        # print(f1_l[1].shape) # torch.Size([8, 64, 128, 128])
        # print(f1_l[2].shape) # torch.Size([8, 64, 64, 64])
        ...
        # fusion subnet
        F_ = torch.cat((f1_aligned_l, f1_t_,  f2_, f2_t, f3_aligned_l, f3_t_), 1) #(8,384,256,256)
        F_0 = self.conv1(F_)
        F_1 = self.RDB1(F_0)
        F_2 = self.RDB2(F_1)
        F_3 = self.RDB3(F_2)
