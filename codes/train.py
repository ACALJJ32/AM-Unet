...
def main():
    ...
    parser.add_argument('--opt', default='./options/train/train_HDR.yml', type=str, help='Path to option YMAL file.')
    ...
    for epoch in range(start_epoch, total_epochs + 1):
        ...
        for _, train_data in enumerate(train_loader):
            ...
            model.feed_ldrs_data(train_data)
            ...
            if current_step % opt['train']['val_freq'] == 0 and rank <= 0:
                ...
                for val_data in val_loader:
                    ...
                    model.feed_ldrs_data(val_data)
                    model.test()

                    visuals = model.get_current_visuals()

                    sr_img = util.tensor2numpy(visuals['Result']) # float32
